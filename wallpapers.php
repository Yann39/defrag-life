...
<head>
<title>Defrag-life - Wallpapers</title>
              ...
              <tr> 
                <td style="margin-left:auto;margin-right:auto;">
                     <div style="margin-left:auto;margin-right:auto;">
                      ...
                      <div class="news_titre">Wallpapers</div>
                      <img style="margin-top:4px;margin-bottom:20px;" src="images/Dividers_long.gif" alt=""/>
					</div>
					<div style="text-align:center;" class="couleur_blanc">
					You can get all wallpapers by downloading the <a href="downloads/wallpapers_pack.zip">wallpapers pack</a> (12.2 Mb).
				  </div><br/>
				  <div style="text-align:left;margin-left:auto;margin-right:auto;" class="couleur_bleu">
					<table style="margin-left:auto;margin-right:auto;width:666px;" cellpadding="0" cellspacing="0">
                      <tr>
                        <td style="height:260px;border-width:1px;border-style:solid;border-color:#bed4ff;text-align:center;"><img src="images/wallpapers/wallpaper1r.jpg" alt=""/></td>
                      ...
                      <tr>
                        <td style="height:260px;border-width:1px;border-style:solid;border-color:#bed4ff;text-align:center;"><img src="images/wallpapers/wallpaper2r.jpg" alt=""/></td>
						<td style="width:300px;border-width:1px;border-style:solid;border-color:#bed4ff;border-left:none;">
                            <p style="margin-left:10px;">
							<span class="couleur_bleu_souligne">Author :</span> MegA-TecK<br/><br/>
					  ...
					  <tr style="height:15px;"><td></td><td></td></tr>
                      <tr>  
                        <td style="height:260px;border-width:1px;border-style:solid;border-color:#bed4ff;text-align:center;"><img src="images/wallpapers/wallpaper3r.jpg" alt=""/></td>
						<td style="width:300px;border-width:1px;border-style:solid;border-color:#bed4ff;border-left:none;">
							<p style="margin-left:10px;">
							<span class="couleur_bleu_souligne">Author :</span> MegA-TecK<br/><br/>
					  ...
					  <tr style="height:15px;"><td></td><td></td></tr>
                      <tr>
                        <td style="height:260px;border-width:1px;border-style:solid;border-color:#bed4ff;text-align:center;"><img src="images/wallpapers/wallpaper4r.jpg" alt=""/></td>
						<td style="width:300px;border-width:1px;border-style:solid;border-color:#bed4ff;border-left:none;">
							<p style="margin-left:10px;">
							<span class="couleur_bleu_souligne">Author :</span> MegA-TecK<br/><br/>
					  ...
					  <tr style="height:15px;"><td></td><td></td></tr>
                      <tr>
                        <td style="height:260px;border-width:1px;border-style:solid;border-color:#bed4ff;text-align:center;"><img src="images/wallpapers/wallpaper5r.jpg" alt=""/></td>
						<td style="width:300px;border-width:1px;border-style:solid;border-color:#bed4ff;border-left:none;">
							<p style="margin-left:10px;">
							<span class="couleur_bleu_souligne">Author :</span> MegA-TecK<br/><br/>
					  ...
					  <tr style="height:15px;"><td></td><td></td></tr>
                      <tr>
                        <td style="height:260px;border-width:1px;border-style:solid;border-color:#bed4ff;text-align:center;"><img src="images/wallpapers/wallpaper6r.jpg" alt=""/></td>
						<td style="width:300px;border-width:1px;border-style:solid;border-color:#bed4ff;border-left:none;">
							<p style="margin-left:10px;">
							<span class="couleur_bleu_souligne">Author :</span> MegA-TecK<br/><br/>
					  ...
					  <tr style="height:15px;"><td></td><td></td></tr>
                      <tr>  
                        <td style="height:260px;border-width:1px;border-style:solid;border-color:#bed4ff;text-align:center;"><img src="images/wallpapers/wallpaper7r.jpg" alt=""/></td>
						<td style="width:300px;border-width:1px;border-style:solid;border-color:#bed4ff;border-left:none;">
							<p style="margin-left:10px;">
							<span class="couleur_bleu_souligne">Author :</span> MegA-TecK<br/><br/>
					  ...
					  <tr style="height:15px;"><td></td><td></td></tr>
					  <tr>
                        <td style="height:260px;border-width:1px;border-style:solid;border-color:#bed4ff;text-align:center;"><img src="images/wallpapers/wallpaper8r.jpg" alt=""/></td>
						<td style="width:300px;border-width:1px;border-style:solid;border-color:#bed4ff;border-left:none;">
							<p style="margin-left:10px;">
							<span class="couleur_bleu_souligne">Author :</span> MegA-TecK<br/><br/>
					  ...
					  <tr style="height:15px;"><td></td><td></td></tr>
					  <tr>
                        <td style="height:260px;border-width:1px;border-style:solid;border-color:#bed4ff;text-align:center;"><img src="images/wallpapers/wallpaper9r.jpg" alt=""/></td>
						<td style="width:300px;border-width:1px;border-style:solid;border-color:#bed4ff;border-left:none;">
							<p style="margin-left:10px;">
							<span class="couleur_bleu_souligne">Author :</span> MegA-TecK<br/><br/>
					  ...
					  <tr style="height:15px;"><td></td><td></td></tr>
					  <tr>
                        <td style="height:260px;border-width:1px;border-style:solid;border-color:#bed4ff;text-align:center;"><img src="images/wallpapers/wallpaper10r.jpg" alt=""/></td>
						<td style="width:300px;border-width:1px;border-style:solid;border-color:#bed4ff;border-left:none;">
							<p style="margin-left:10px;">
							<span class="couleur_bleu_souligne">Author :</span> MegA-TecK<br/><br/>
					  ...
					  <tr style="height:15px;"><td></td><td></td></tr>
					  <tr>
                        <td style="height:260px;border-width:1px;border-style:solid;border-color:#bed4ff;text-align:center;"><img src="images/wallpapers/wallpaper11r.jpg" alt=""/></td>
						<td style="width:300px;border-width:1px;border-style:solid;border-color:#bed4ff;border-left:none;">
							<p style="margin-left:10px;">
							<span class="couleur_bleu_souligne">Author :</span> MegA-TecK<br/><br/>
					  ...
					  <tr style="height:15px;"><td></td><td></td></tr>
					  <tr>
                        <td style="height:260px;border-width:1px;border-style:solid;border-color:#bed4ff;text-align:center;"><img src="images/wallpapers/wallpaper12r.jpg" alt=""/></td>
						<td style="width:300px;border-width:1px;border-style:solid;border-color:#bed4ff;border-left:none;">
							<p style="margin-left:10px;">
							<span class="couleur_bleu_souligne">Author :</span> MegA-TecK<br/><br/>
