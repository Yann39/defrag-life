							  ...
							  <table style='margin-left:auto;margin-right:auto;margin-top:3px;margin-bottom:30px;width:300px;border:none;' cellspacing='0' cellpadding='0'> 
                                ...
                                <tr> 
                                  <td>
									...
									$cpt2=1;
									$ok=0;
									$sql2 = "SELECT pays, joueur, map j, COUNT(id), ROUND(SUM((SELECT MIN(temps) FROM dl_Demos WHERE map=j)/temps)*10,2) AS TotalPoints FROM dl_Demos WHERE physics='".$phys."' AND valide=1 GROUP BY joueur ORDER BY TotalPoints DESC";
